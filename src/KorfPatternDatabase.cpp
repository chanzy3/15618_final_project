...
namespace busybin
{
   ...
   * dbs.
   */
  KorfPatternDatabase::KorfPatternDatabase(CornerPatternDatabase* pCornerDB):
   ...
   */
  uint8_t KorfPatternDatabase::getNumMoves(const cube_t* cube) const
  {
    uint8_t cornerMoves;
    uint8_t edgeG1Moves;
    uint8_t edgeG2Moves;
    ...
    return max({cornerMoves
    // , edgeG1Moves, edgeG2Moves, edgePermMoves
    });
  }
   ...
   * getNumMoves.
   */
  uint8_t KorfPatternDatabase::getNumMovesEx(const cube_t* cube,
   ...
   */
  bool KorfPatternDatabase::setNumMoves(const cube_t* cube, const uint8_t numMoves)
  {
  ...
  uint32_t KorfPatternDatabase::getDatabaseIndex(const cube_t* cube) const
  {
