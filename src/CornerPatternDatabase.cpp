...
namespace busybin
{
   ...
   */
  uint32_t CornerPatternDatabase::getDatabaseIndex(const cube_t* cube) const
  {
    ...
    perm_t cornerPerm =
    {
      //TODO: impelement getCornerIndex (chengzhh)
      getCornerIndex(cube, CORNER::ULB),
      getCornerIndex(cube, CORNER::URB),
      getCornerIndex(cube, CORNER::URF),
      getCornerIndex(cube, CORNER::ULF),
      getCornerIndex(cube, CORNER::DLF),
      getCornerIndex(cube, CORNER::DLB),
      getCornerIndex(cube, CORNER::DRB),
      getCornerIndex(cube, CORNER::DRF)
    };
    ...
    {
      getCornerOrientation(cube, CORNER::ULB),
      getCornerOrientation(cube, CORNER::URB),
      getCornerOrientation(cube, CORNER::URF),
      getCornerOrientation(cube, CORNER::ULF),
      getCornerOrientation(cube, CORNER::DLF),
      getCornerOrientation(cube, CORNER::DLB),
      getCornerOrientation(cube, CORNER::DRB)
    };
