...
namespace busybin
{
  ...
  void KorfCubeSolver::indexCornerDatabase()
  {
    ...
    // }
    this->cornerDB.fromFile("./Data/corner.pdb");
  ...
  void KorfCubeSolver::indexEdgeG1Database()
  {
    ...
    // }
    this->edgeG1DB.fromFile("./Data/edgeG1.pdb");
  ...
  void KorfCubeSolver::indexEdgeG2Database()
  {
    ...
    // }
    this->edgeG2DB.fromFile("./Data/edgeG2.pdb");
  ...
  void KorfCubeSolver::indexEdgePermDatabase()
  {
    ...
    // }
    this->edgePermDB.fromFile("./Data/edge_perm.pdb");
   ...
   */
  void KorfCubeSolver::solveCube(RubiksCubeIndexModel &iCube)
  {
    // RubiksCubeView cubeView;
    vector<RubiksCubeModel::MOVE>   allMoves;
    vector<RubiksCubeModel::MOVE>   goalMoves;
    ...
    // RubiksCubeIndexModel iCube(cube);
    cout << "finish loading cube index model" << endl;
    ...
    if (iCube.isSolved())
      ...
      cout << "Cube is not Solved yet, check your algorithm!" << endl;
    // // Print the moves.
